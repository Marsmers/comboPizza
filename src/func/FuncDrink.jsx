...
const FuncDrink = () => {
	...
	useEffect(() => {
		axios
			.get(
				'https://kombo-939008f7ecb9.herokuapp.com/public/product?direction=ASC&page=0&productType=DRINK&size=8'
			)
			.then(response => {
	...
	const loadMoreDrink = () => {
		if (currentPage < totalPages - 1) {
			...
			axios
				.get(
					`https://kombo-939008f7ecb9.herokuapp.com/public/product?direction=ASC&page=${nextPage}&productType=DRINK&size=8`
				)
				.then(response => {
				...
				<div key={index} className={styles.card}>
					<div className={styles['img-card']}>
						<img
							...
							src={drink.mainImageUrl}
							alt='Комбо напої Стрий'
						/>
					</div>
					...
					<div className={styles.footerCard}>
						<div className={styles.footerBottom}>
							<h3 className={styles.cardFooterPrice}>{drink.price} грн</h3>
							<button
